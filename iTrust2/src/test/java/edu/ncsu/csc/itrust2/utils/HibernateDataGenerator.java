...
public class HibernateDataGenerator {
    ...
    public static void main ( final String args[] ) {
        refreshDB();
        // Create a default diagnosis of None
    ...
    public static void refreshDB () {
        ...
        final User testuser = new User( "testuser", "$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.",
                Role.ROLE_PATIENT, 1 );
        testuser.save();

        // CREATE A DIAGNOSIS
        try {
            final DiagnosisForm df = new DiagnosisForm( "Influenza", "J10" );
            final Diagnosis influenza = new Diagnosis( df );
            influenza.save();
        }
    ...
    public static void generateUsers () {
        ...
        final User antti = new User( "antti", "$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.",
                Role.ROLE_PATIENT, 1 );
        antti.save();
    }
}
