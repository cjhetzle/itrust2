...
public class User extends DomainObject<User> implements Serializable {
     ...
     * @param repeat
     *            copy of newPAss, must match
     *
     * @return success/error message
     */
    public String changePass ( String old, String newPass, String repeat ) {
        final PasswordEncoder pe = new BCryptPasswordEncoder();

        if ( pe.matches( old, this.getPassword() ) ) {
            setPassword( pe.encode( newPass ) );
            return "Success";
        }
        else {
