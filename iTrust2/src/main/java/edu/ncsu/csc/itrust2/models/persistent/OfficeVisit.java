...
public class OfficeVisit extends DomainObject<OfficeVisit> {
    ...
    // **************NEW***********************************************
    /**
     * Set diagnosis of the office visit
     *
     * @param code
     *            icd code for the diagnosis
     */
    public void setDiagnosis ( final String code ) {

        this.diagnosis = Diagnosis.getByIcdCode( code );
    }

    /**
     * Gets the diagnosis of this office visit
     *
