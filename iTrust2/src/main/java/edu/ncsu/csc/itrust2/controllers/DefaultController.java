...
public class DefaultController {
     ...
     */
    @RequestMapping ( value = "password/forgotPassword" )
    ...
    /**
     * Gets the token reset password page
     *
     * @param model
     *            Data for the front end
     * @return Page to show to the user
     */
    @RequestMapping ( value = "password/tokenPasswordReset" )
    public String tokenPasswordReset ( final Model model ) {
        model.addAttribute("ResetPasswordForm", new ResetPasswordForm());
        return "password/tokenPasswordReset";
    }
}
