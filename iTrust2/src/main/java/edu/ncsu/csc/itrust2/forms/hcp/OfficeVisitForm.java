...
public class OfficeVisitForm implements Serializable {
    ...
    // New stuff************************************************************
    /** ICD Code of the diagnosis for this office visit form */
    ...
    public OfficeVisitForm ( final OfficeVisit ov ) {
        ...
        setIcdCode( ov.getDiagnosis().getIcdCode() );
    ...
    // ***NEW STUFF***********************************************
    /**
     * Sets the icd code of the form
     *
     * @param code
     *            icd code of the selected diagnosis
     */
